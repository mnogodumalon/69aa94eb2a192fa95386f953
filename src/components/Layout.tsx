...
import { FileText, LayoutDashboard, Menu, Settings, Tag, X } from 'lucide-react';
import { useState } from 'react';
import ChatWidget from '@/components/ChatWidget';

// ⚡ Customize these for your app
const APP_TITLE = 'Straßenschaden-Management';
...
const navigation = [
  ...
  { name: 'Schadensmeldung', href: '/schadensmeldung', icon: FileText },
  { name: 'Schadenskategorien', href: '/schadenskategorien', icon: Tag },
  { name: 'Bearbeitungsstatus', href: '/bearbeitungsstatus', icon: FileText },
];
